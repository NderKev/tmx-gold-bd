...
contract TMXGoldTokenSaleV1 is Ownable, ReentrancyGuard {
    ...
    function buyTokens(uint256 tokenAmount) external payable nonReentrant saleActive {
        ...
        require(contractBalance >= amount, "Not enough tokens in sale contract");

        tokensSold += amount;
       
        tmxToken.transfer(msg.sender, amount);
